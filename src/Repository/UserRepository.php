...
class UserRepository extends AbstractRepository implements PasswordUpgraderInterface
{
    ...
    public function getCustomers(CustomerSearch $search): ?QueryBuilder
    {
     ...
     */
    public function getAdmins(CustomerSearch $search): ?QueryBuilder
    {
        $qb = $this->createQueryBuilder('u');
     ...
     */
    public function findCustomerEmails()
    {
        $qb = $this->createQueryBuilder('u')
            ->select('u.email');
